...
df0.to_csv('newly_confirmed_cases_daily_Tokyo.csv', encoding="ANSI", index=False)

ax1.bar(df0["Date"],df0["Tokyo"], label="東京都の感染者数_1日ごとの発表数",color='royalblue',width=0.85,align="center")
...
ax2.bar(df0["Date"],df0["死者数"], label="東京都の死者数_1日ごとの発表数", color='red',width=0.6,align="center")
