...
/*
<applet code="MousePicking.class" width="1000" height="550">
</applet>
*/
...
/* ---------------- 光源の定義 --------------------------*/
      Color3f color3fD = new Color3f(1.0f, 1.0f, 1.0f);            // 白
...
/* ----------------- 空間全体を照らす光を定義 -------------*/
      Color3f color3fA = new Color3f(1.0f, 1.0f, 1.0f);             //白　　
...
/* -------------------------------------------------------------*/
      Color3f color3f = new Color3f(1.0f, 1.0f, 1.0f);          //白
