...
/*
<applet code="MyView.class" width=1000 height=600
 name="test" align=middle alt="Error : Can't load applet">
</applet>
*/
...
public class MyView extends Applet
{
	...
	public void init()
	{
		...
		//root=myObject.buildStage();

		universe.addBranchGraph(myObject.buildStage());
