...
public class RectangleYZ extends Shape3D{
   ...
   private static Geometry createGeometry(){
    ...
    vertices[0] = new Point3f(x, -1.0f, -1.0f);
    vertices[1] = new Point3f(x,  1.0f, -1.0f);
    vertices[2] = new Point3f(x,  1.0f,  1.0f);
    vertices[3] = new Point3f(x,  -1.0f, 1.0f);
    ...
    Color3f[] colors = new Color3f[2];
      ...
      colors[0] = new Color3f(0.0f, 0.5f, 0.5f);   // blue              
      colors[1] = new Color3f(0.5f, 0.5f, 0.0f);   // brown              
