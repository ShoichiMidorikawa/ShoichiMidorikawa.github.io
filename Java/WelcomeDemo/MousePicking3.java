...
/*
<applet code="MousePicking3" width=900 height=500>
</applet>
*/


public class MousePicking3 extends Applet{

   public MousePicking3(){
...
/* ----------------- ファイルの呼び出し--------------------*/
   public static void main(String[] args){
      MousePicking3 mousePicking3 = new MousePicking3();
      MainFrame frame = new MainFrame(mousePicking3, 900, 500);
   }
}
