/*       ParabolicCyl1.java (parabolic cylinder 放物柱面) 　　   */
/*       材質を設定                             　　　　　　　　 */
/*       インデックス付き4角形ポリゴン(完成)                     */
...
public class ParabolicCyl1 extends Shape3D{

   public ParabolicCyl1(){
   ...
   private static Geometry createGeometry(){
    ...
    Point3f[] vertices = new Point3f[n*m];
      ...
      float theta0 = -(float)(Math.PI-0.3f)/2.0f;
      float phi0 = -1.0f;
    
      float Dtheta = (float)(Math.PI-0.3f)/(n-1);
   ...
   private static Appearance createAppearance(){
    ...
    Color3f color3f = new Color3f(1.0f, 0.0f, 0.0f);  // 赤
