...
/*
<applet code="DBA3.class" width=900 height=600>
</applet>
*/

public class DBA3 extends Applet implements ActionListener, Runnable {
  Scrollbar scr;
  ...
  int nx, sx;
  int k = 12;
  int pw = 8191;  // パノラマ写真の幅
  int ph = 1489;   // パノラマ写真の縦
  ...
  public void init() {
    ...
    scr = new Scrollbar(Scrollbar.HORIZONTAL, 70, 10, 30, 200);
    ...
    add("North", p);
     ...
     image = getImage(getDocumentBase(), "sakura.jpg");
     mt.addImage(image,0);
